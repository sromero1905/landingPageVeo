    ...
    <>
      ...
      <motion.div
        style={{
          ...
          transform,
          background:
            "linear-gradient(90deg, rgba(0,0,0,1) 0%, rgba(169,169,169,1) 50%, rgba(255,255,255,1) 100%)", // Gradient from black to gray to white
          mixBlendMode: "overlay", // Optional: Adjust the blend mode for a better effect
        }}
      >
        {children}
      </motion.div>
